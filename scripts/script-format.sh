...
grep -E "Time|tree" result > grep-tt

grep -E -A 2 "depth" grep-tt > grep-depth
./script-csv.py grep-depth > grep-depth.csv

grep -E -A 2 "binary" grep-tt > grep-binary
./script-csv.py grep-binary > grep-binary.csv

grep -E -A 2 "random" grep-tt > grep-random
./script-csv.py grep-random > grep-random.csv

./script-con.py grep-random.csv grep-depth.csv grep-binary.csv result.csv
